...
// Precedence: a compile failure means nothing else ran, so it wins over
// everything; then our own timeout, then the kernel's OOM signal, then a
// non-zero exit (covers segfaults/uncaught exceptions/div-by-zero
